...
const customRender = (ui: JSX.Element, { providerProps, ...renderOptions }: CustomRenderOptions) =>
  render(<WizardContext.Provider {...providerProps}>{ui}</WizardContext.Provider>, renderOptions);
